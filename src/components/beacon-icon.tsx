...
export function BeaconIcon({
  ...
  return (
    <svg className={className} viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <path d="M32 42 L24 8 L40 8 Z" fill={`url(#${beamGradientId})`} opacity="0.6">
        <animate attributeName="opacity" values="0.4;0.7;0.4" dur="2s" repeatCount="indefinite" />
      </path>

      <path d="M32 42 L28 8 L36 8 Z" fill={`url(#${beamGradientInnerId})`} opacity="0.8">
        <animate attributeName="opacity" values="0.6;1;0.6" dur="1.5s" repeatCount="indefinite" />
      </path>

      <defs>
        <linearGradient id={beamGradientId} x1="32" y1="42" x2="32" y2="8" gradientUnits="userSpaceOnUse">
          <stop offset="0%" stopColor={accentColor} />
          <stop offset="100%" stopColor={accentColor} stopOpacity="0" />
        </linearGradient>
        <linearGradient id={beamGradientInnerId} x1="32" y1="42" x2="32" y2="8" gradientUnits="userSpaceOnUse">
