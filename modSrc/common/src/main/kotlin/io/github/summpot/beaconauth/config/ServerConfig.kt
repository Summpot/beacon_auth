...
object ServerConfig {
    ...
    fun load(configDir: Path) {
        ...
        try {
            ...
            bypassIfOnlineModeVerified = props
                .getProperty("auth.bypass_if_online_mode_verified", DEFAULT_BYPASS_ONLINE_MODE.toString())
                .toBooleanStrictOrNull() ?: DEFAULT_BYPASS_ONLINE_MODE
            forceAuthIfOfflineMode = props
                .getProperty("auth.force_auth_if_offline_mode", DEFAULT_FORCE_AUTH_OFFLINE.toString())
                .toBooleanStrictOrNull() ?: DEFAULT_FORCE_AUTH_OFFLINE
            allowVanillaOfflineClients = props
                .getProperty("auth.allow_vanilla_offline_clients", DEFAULT_ALLOW_VANILLA_OFFLINE.toString())
                .toBooleanStrictOrNull() ?: DEFAULT_ALLOW_VANILLA_OFFLINE
