...
object AuthServer {
    ...
    private val authenticatedPlayers = mutableSetOf<java.util.UUID>()
    ...
    /**
     * Handle login URL request from client
     * Stateless - builds URL from packet data
     */
    /**
    ...
    fun verifyForProfile(profileName: String, jwt: String, verifier: String): VerificationResult {
        return try {
            ...
            val jwtChallenge = claims.getStringClaim("challenge") ?: throw SecurityException("JWT missing 'challenge' claim")
